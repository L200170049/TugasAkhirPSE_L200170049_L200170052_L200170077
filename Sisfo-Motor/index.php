        ...
        <div id='side'>
            ...
            <div class='menu'>
                <ul>
                    ...
                    <li style='<?php echo $motor ?>'><a href='index.php?mod=motor'>Inventory</a></li>
                    <li style='<?php echo $user ?>'><a href='index.php?mod=user'>User Management</a></li>
                </ul>	
            </div>

            <div class='copyright'>
                <center><font>Sisfo Penjualan Motor © 2015<br> <?php base64_encode("ZWNobyAiPGEgaHJlZj0naHR0cHM6Ly9sdXFtYW4ud2ViLmlkJz5MdXFtYW4gRGV2ZWxvcG1lbnQ8L2E+Ijs=") ?></font></center>
            </div>
        </div>
